...
class CasesTransformer extends TransformerAbstract
{
    ...
    public function transform(Cases $cases)
    {
        return [
            ...
            'egfr'               => $cases->egfr,
            'foot_chk_left'      => $cases->foot_chk_left,
            'foot_chk_right'     => $cases->foot_chk_right,
            'ulcers'             => $cases->ulcers,
            ...
            'intermittentpain'   => $cases->intermittentpain,
            'abi'                => $cases->abi,
            ...
            'medicaltreatment'   => $cases->medicaltreatment,
            'medicaltreatment_times' => $cases->medicaltreatment_times,
            'drinking'           => $cases->drinking,
            ...
            'followdisease'      => $cases->followdisease,
