...
//        $post->title = hash('adler32', time());
        ...
        LogsController::saveLog('posts', 'store(保存)', $request->ip(), $this->useragent);
    ...
    public function update(Request $request, Post $post)
    {
        ...
        LogsController::saveLog('posts', 'update(更新)', $request->ip(), $this->useragent);
        return $this->respondWith($post, new PostTransformer);
    }
    ...
    public function destroy(Request $request, Post $post)
    {
        ...
        LogsController::saveLog('posts', 'destroy(删除)', $request->ip(), $this->useragent);
