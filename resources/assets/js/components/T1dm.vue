<template>
  <section class="content">
    ...
    <div class="callout callout-info lead">
      <h4>基本資料(T1DM)管理</h4>
      <h5><p>
        您可以在此管理::[<b>基本資料(T1DM)</b>]--(<b>本共照平台的病患</b>)，功能有：<b>新增、修改、刪除、清除</b>...等
      </p></h5>
    </div>
              ...
              <tabs :active.sync="active">
                <tab header="基本資料(T1DM)-查詢">
                  ...
                  <div class="col-xs-12 col-xs-offset-3">
                    <button type="button" class="btn btn-primary" :disabled="!valid.query" @click="createBasist1dm()"><i class="fa fa-plus-circle"></i>新增</button>
                    <button type="button" class="btn btn-info" :disabled="!valid.query" @click="clear2(basiscache)"><i class="fa fa-eraser"></i>清除</button>
                  </div>
                </tab>
                <tab header="基本資料(T1DM)-新增" :disabled="!disablequery">
                  <form-group :valid.sync="valid.create">
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        ...
                        <datepicker v-ref:dp :value.sync="basist1dm.log_date" :disabled-days-of-Week="disabled" :format="format.toString()" :clear-button="clear" width="370px"></datepicker>
                      </div>
                      <div class="col-xs-1 col-xs-offset-1"><span> </span></div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-xs-3">
                        <multiselect :options="yearoptions" :selected.sync="basist1dm.fall_ill_year" :multiple="false" :searchable="true" :close-on-select="false"
                                     :show-labels="false" @update="updateYear" label="fall_ill_year">  </multiselect>
                        <!-- v-select name="fall_ill_year" :options="yearoptions" :value.sync="basist1dm.fall_ill_year" clear-button></v-select -->
                      </div>
                      <label class="control-label col-xs-1" for="diagnosemonth">月份</label>
                      <div class="col-xs-2">
                        <multiselect :options="monthoptions" :selected.sync="basist1dm.fall_ill_month" :multiple="false" :searchable="true" :close-on-select="false"
                                     :show-labels="false" @update="updateMonth" label="fall_ill_month">  </multiselect>
                        <!-- v-select name="fall_ill_month" :options="['01','02','03','04','05','06','07','08','09','10','11','12','不詳']" :value.sync="basist1dm.fall_ill_month" clear-button></v-select -->
                      </div>
                      <div class="col-xs-1 col-xs-offset-1"><span> </span></div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        <p><pre>Values: {{ basist1dm.symptom }}</pre></p>
                        <button-group :value.sync="basist1dm.symptom" buttons="false">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        <button-group :value.sync="basist1dm.treatment" buttons="false">
                          <p><pre>Values: {{ basist1dm.treatment }}</pre></p>
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-10">
                              <div class="row">
                                <div class="col-xs-12">
                                  <multiselect :options="['Metformin','SU','Glinide','DPP4-I','SGLT-2','TZD','Acarbose']" :selected.sync="basist1dm.medication"
                              ...
                              <div class="row">
                                ...
                                <div class="col-xs-4">
                                  <multiselect :options="yearoptions" :selected.sync="basist1dm.medication_year" :multiple="false" :searchable="true" :close-on-select="false"
                                ...
                                <div class="col-xs-4">
                                  <multiselect :options="monthoptions" :selected.sync="basist1dm.medication_month" :multiple="false" :searchable="true" :close-on-select="false"
                          ...
                          <!-- div class="row" -->
                            <div class="row">
                              ...
                              <div class="col-xs-10">
                                ...
                                <div class="col-xs-3">
                                  <multiselect :options="yearoptions" :selected.sync="basist1dm.injection_year" :multiple="false" :searchable="true" :close-on-select="false"
                                ...
                                <div class="col-xs-3">
                                  <multiselect :options="monthoptions" :selected.sync="basist1dm.injection_month" :multiple="false" :searchable="true" :close-on-select="false"
                            ...
                            <div class="row">
                              <div class="col-xs-6 col-xs-offset-4">
                                <bs-input name="insulin" :value.sync="basist1dm.insulin" :disabled="isNoneT"></bs-input>
                              </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-10">
                              <label class="control-label col-xs-2" for="injectionyear">西元年</label>
                              <div class="col-xs-3">
                                <multiselect :options="yearoptions" :selected.sync="basist1dm.glp1_year" :multiple="false" :searchable="true" :close-on-select="false"
                              ...
                              <div class="col-xs-3">
                                <multiselect :options="monthoptions" :selected.sync="basist1dm.glp1_month" :multiple="false" :searchable="true" :close-on-select="false"
                                             :show-labels="false" @update="updateiMonth" label="glp1_month" :disabled="isNoneT">  </multiselect>
                              </div>
                              <div class="col-xs-3">
                                <v-select name="glp1" :options="['無','2次/天','1次/天','1次/周','1次/月']" :value.sync="basist1dm.glp1" clear-button :disabled="isNoneT"></v-select>
                              </div>
                            </div>
                          </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        <v-select name="continuous" :options="['無','規則治療','不規則治療']" :value.sync="basist1dm.continuous" clear-button></v-select>
                      </div>
                      <div class="col-xs-1 col-xs-offset-1"><span> </span></div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        <button-group :value.sync="basist1dm.comorbidity" buttons="false">
                          <p><pre>Values: {{ basist1dm.comorbidity }}</pre></p>
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-10">
                              <multiselect :options="['COPD','開放型','非開放性']" :selected.sync="basist1dm.lung"
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-10">
                              <multiselect :options="['A型肝炎','B型肝炎','C型肝炎','脂肪肝','肝硬化']" :selected.sync="basist1dm.liver"
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-10">
                              <multiselect :options="['失眠','焦慮','憂鬱','躁鬱','精神功能症','失智','其他']" :selected.sync="basist1dm.mental"
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-10">
                              <bs-input name="cancer" :value.sync="basist1dm.cancer" :disabled="isNoneC"></bs-input>
                            </div>
                          </div>
                        </button-group>
                      </div>
                    ...
                    <div v-if="isFemale">
                      <div class="row">
                        ...
                        <div class="col-xs-7">
                          <multiselect :options="['不詳','0次','1次','2次','3次','4次','5次','6次','7次','8次','9次','10次']" :selected.sync="basist1dm.gestation"
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-7">
                          <multiselect :options="['不詳','0次','1次','2次','3次','4次','5次','6次','7次','8次','9次','10次']" :selected.sync="basist1dm.stopgestation"
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        <button-group :value.sync="basist1dm.complication" buttons="false">
                          <p><pre>Values: {{ basist1dm.complication }}</pre></p>
                          <v-checkbox value="無">無</v-checkbox>
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-10">
                              <multiselect :options="['支架','冠狀動脈繞道術','氣球擴張術','其他']" :selected.sync="basist1dm.heartdisease"
                                           :multiple="true" :searchable="true" :close-on-select="false" :show-labels="false" @update="updateHeartdisease"
                                           label="heartdisease" :disabled="isNoneN">  </multiselect>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-10">
                              <multiselect :options="['糖尿病','非糖尿病']" :selected.sync="basist1dm.blindness"
                                           :multiple="false" :searchable="true" :close-on-select="false" :show-labels="false" @update="updateBlindness"
                                           label="blindness" :disabled="isNoneN">  </multiselect>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-xs-2">
                            ...
                            <div class="col-xs-10">
                              <multiselect :options="['糖尿病','非糖尿病']" :selected.sync="basist1dm.dialysis"
                                           :multiple="false" :searchable="true" :close-on-select="false" :show-labels="false" @update="updateDialysis"
                                           label="dialysis" :disabled="isNoneN">  </multiselect>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-xs-2">
                            ...
                            <div class="col-xs-10">
                              <multiselect :options="['糖尿病','非糖尿病']" :selected.sync="basist1dm.amputation"
                                           :multiple="false" :searchable="true" :close-on-select="false" :show-labels="false" @update="updateAmputation"
                                           label="amputation" :disabled="isNoneN">  </multiselect>
                            </div>
                          </div>
                        </button-group>
                      </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        <button-group :value.sync="basist1dm.fami_medic_his" buttons="false">
                          <p><pre>Values: {{ basist1dm.fami_medic_his }}</pre></p>
                          <v-checkbox value="無">無</v-checkbox>
                          <v-checkbox value="不詳">不詳</v-checkbox>
                          <div class="row">
                            <div class="col-xs-2">
                            ...
                            <div class="col-xs-10">
                              <multiselect :options="['父系','母系','兄弟姐妹','子女','孫子女']" :selected.sync="basist1dm.relatives"
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-10">
                              <multiselect :options="['父系','母系','兄弟姐妹','子女','孫子女']" :selected.sync="basist1dm.hypertension"
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-10">
                              <multiselect :options="['父系','母系','兄弟姐妹','子女','孫子女']" :selected.sync="basist1dm.cardiovascular"
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-10">
                              <multiselect :options="['父系','母系','兄弟姐妹','子女','孫子女']" :selected.sync="basist1dm.stroke"
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        <multiselect :options="['無','輕','中','重','臥床']" :selected.sync="basist1dm.activity"
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        <multiselect :options="['不詳','不識字','識數字','識字','日教','國小','國中','高中','大專','大學','碩士','博士']" :selected.sync="basist1dm.education"
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        <bs-input name="occupation" :value.sync="basist1dm.occupation" placeholder="若無，請忽略此欄；若有，請填寫!"></bs-input>
                      </div>
                      <div class="col-xs-1 col-xs-offset-1"><span> </span></div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        <p><pre>Radio value: {{ basist1dm.worktime | json }}</pre></p>
                        <div class="row">
                          <div class="col-xs-2">
                            <radio :checked.sync="basist1dm.worktime" value="固定" type="info">固定</radio>
                          </div>
                          <div class="col-xs-10">
                            <!-- p><pre>Value: {{-- basist1dm.fixedtime_from | json }}</pre></p -->
                            <vue-timepicker :time-value.sync="basist1dm.fixedtime_from" format="HH:mm"></vue-timepicker>～
                            <vue-timepicker :time-value.sync="basist1dm.fixedtime_to" format="HH:mm"></vue-timepicker>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-xs-2">
                            <radio :checked.sync="basist1dm.worktime" value="不固定" type="danger">不固定</radio>
                          </div>
                          <div class="col-xs-10">
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-xs-2">
                            <radio :checked.sync="basist1dm.worktime" value="輪班" type="warning">輪班</radio>
                          </div>
                          <div class="col-xs-10">
                            <div class="row">
                              <label class="control-label col-xs-2" for="dayshift">日班</label>
                              <div class="col-xs-10">
                                <vue-timepicker :time-value.sync="basist1dm.dayshift_from" format="HH:mm"></vue-timepicker>～
                                <vue-timepicker :time-value.sync="basist1dm.dayshift_to" format="HH:mm"></vue-timepicker>
                              </div>
                            </div>
                            <div class="row">
                              <label class="control-label col-xs-2" for="middleshift">中班</label>
                              <div class="col-xs-10">
                                <vue-timepicker :time-value.sync="basist1dm.middleshift_from" format="HH:mm"></vue-timepicker>～
                                <vue-timepicker :time-value.sync="basist1dm.middleshift_to" format="HH:mm"></vue-timepicker>
                              </div>
                            </div>
                            <div class="row">
                              <label class="control-label col-xs-2" for="nightshift">晚班</label>
                              <div class="col-xs-10">
                                <vue-timepicker :time-value.sync="basist1dm.nightshift_from" format="HH:mm"></vue-timepicker>～
                                <vue-timepicker :time-value.sync="basist1dm.nightshift_to" format="HH:mm"></vue-timepicker>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        <multiselect :options="['聽力障礙','視力障礙','手部不靈活','失聰','失明','智力障礙','情緒因素','疾病因素','其他']" :selected.sync="basist1dm.affectlearning"
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        <p><pre>Radio value: {{ basist1dm.livingcondition | json }}</pre></p>
                        <radio :checked.sync="basist1dm.livingcondition" value="獨居" type="info">獨居</radio>
                        <radio :checked.sync="basist1dm.livingcondition" value="與家人同住" type="info">與家人同住</radio>
                        <div class="row">
                          <div class="col-xs-2">
                            <radio :checked.sync="basist1dm.livingcondition" value="安養中心" type="danger">安養中心</radio>
                          </div>
                          <div class="col-xs-10">
                            <multiselect :options="['24小時','日托']" :selected.sync="basist1dm.nursinghome"
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-9">
                            <bs-input name="careunit" :value.sync="basist1dm.careunit" placeholder="請填寫!"></bs-input>
                          </div>
                        </div>
                        <div class="row">
                          <label class="control-label col-xs-2 col-xs-offset-1" for="livingtel">聯絡電話</label>
                          <div class="col-xs-9">
                            <bs-input name="livingtel" :value.sync="basist1dm.livingtel" placeholder="請填寫!"></bs-input>
                          </div>
                        </div>
                      </div>
                      <div class="col-xs-1 col-xs-offset-1"><span> </span></div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        <p><pre>Radio value: {{ basist1dm.selfcare | json }}</pre></p>
                        <radio :checked.sync="basist1dm.selfcare" value="完全獨立" type="info">完全獨立</radio>
                        <radio :checked.sync="basist1dm.selfcare" value="需部分協助照顧" type="info">需部分協助照顧</radio>
                        <radio :checked.sync="basist1dm.selfcare" value="完全由旁人照顧" type="danger">完全由旁人照顧</radio>
                        <div class="row">
                          <label class="control-label col-xs-2 col-xs-offset-1" for="caregiver">照顧者</label>
                          <div class="col-xs-9">
                            <bs-input name="caregiver" :value.sync="basist1dm.caregiver" placeholder="請填寫!"></bs-input>
                          </div>
                        </div>
                        <div class="row">
                          <label class="control-label col-xs-2 col-xs-offset-1" for="caretel">聯絡電話</label>
                          <div class="col-xs-9">
                            <bs-input name="caretel" :value.sync="basist1dm.caretel" placeholder="請填寫!"></bs-input>
                          </div>
                        </div>
                      </div>
                      <div class="col-xs-1 col-xs-offset-1"><span> </span></div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        <p><pre>Radio value: {{ basist1dm.sport | json }}</pre></p>
                        <radio :checked.sync="basist1dm.sport" value="無" type="info">無</radio>
                        <radio :checked.sync="basist1dm.sport" value="不規律" type="info">不規律</radio>
                        <div class="row">
                          <div class="col-xs-2">
                            <radio :checked.sync="basist1dm.sport" value="規律" type="danger">規律</radio>
                          </div>
                          <div class="col-xs-10">
                            <div class="row">
                              <label class="control-label col-xs-2" for="sporta">A種類:</label>
                              <div class="col-xs-3">
                                <bs-input name="sporta1" :value.sync="basist1dm.sporta1" pattern="^[0-9]+$" maxlength="5" placeholder="請填寫!" error="請輸入數值!" clear-button="true" lazy></bs-input>
                              </div>
                              <label class="control-label col-xs-2" for="sporta">次/周</label>
                              <div class="col-xs-3">
                                <bs-input name="sporta2" :value.sync="basist1dm.sporta2" pattern="^[0-9]+$" maxlength="5" placeholder="請填寫!" error="請輸入數值!" clear-button="true"></bs-input>
                              </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-3">
                                <bs-input name="sportb1" :value.sync="basist1dm.sportb1" pattern="^[0-9]+$" maxlength="5" placeholder="請填寫!" error="請輸入數值!" clear-button="true"></bs-input>
                              </div>
                              <label class="control-label col-xs-2" for="sportb">次/周</label>
                              <div class="col-xs-3">
                                <bs-input name="sportb2" :value.sync="basist1dm.sportb2" pattern="^[0-9]+$" maxlength="5" placeholder="請填寫!" error="請輸入數值!" clear-button="true"></bs-input>
                              </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-3">
                                <bs-input name="sportc1" :value.sync="basist1dm.sportc1" pattern="^[0-9]+$" maxlength="5" placeholder="請填寫!" error="請輸入數值!" clear-button="true"></bs-input>
                              </div>
                              <label class="control-label col-xs-2" for="sportc">次/周</label>
                              <div class="col-xs-3">
                                <bs-input name="sportc2" :value.sync="basist1dm.sportc2" pattern="^[0-9]+$" maxlength="5" placeholder="請填寫!" error="請輸入數值!" clear-button="true"></bs-input>
                              </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-5 text-right">
                                <bs-input name="sportsum" :value.sync="basist1dm.sportsum" pattern="^[0-9]+$" maxlength="5" placeholder="自動計算加總" help="此欄位係自動累加上述數值!" :disabled="isSum" icon></bs-input>
                              </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        <p><pre>Radio value: {{ basist1dm.glucometer | json }}</pre></p>
                        <radio :checked.sync="basist1dm.glucometer" value="無" type="info">無</radio>
                        <div class="row">
                          <div class="col-xs-2">
                            <radio :checked.sync="basist1dm.glucometer" value="有" type="danger">有</radio>
                          </div>
                          <div class="col-xs-6">
                            <bs-input name="glucometerfrequency" :value.sync="basist1dm.glucometerfrequency" placeholder="請填寫!"></bs-input>
                          </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        <p><pre>Radio value: {{ basist1dm.g6pd | json }}</pre></p>
                        <radio :checked.sync="basist1dm.g6pd" value="無" type="info">無</radio>
                        <radio :checked.sync="basist1dm.g6pd" value="不詳" type="info">不詳</radio>
                        <div class="row">
                          <div class="col-xs-2">
                            <radio :checked.sync="basist1dm.g6pd" value="有" type="danger">有</radio>
                          </div>
                          <div class="col-xs-10">
                            <label class="control-label col-xs-4" for="g6pdyear">診斷日期: 西元年</label>
                            <div class="col-xs-3">
                              <multiselect :options="yearoptions" :selected.sync="basist1dm.g6pd_year" :multiple="false" :searchable="true" :close-on-select="false"
                            ...
                            <div class="col-xs-3">
                              <multiselect :options="monthoptions" :selected.sync="basist1dm.g6pd_month" :multiple="false" :searchable="true" :close-on-select="false"
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-7">
                        <p><pre>Radio value: {{ basist1dm.closed | json }}</pre></p>
                        <radio :checked.sync="basist1dm.closed" value="無" type="info">無</radio>
                        <div class="row">
                          <div class="col-xs-2">
                            <radio :checked.sync="basist1dm.closed" value="有" type="danger">有</radio>
                          </div>
                          <div class="col-xs-10">
                            <datepicker v-ref:dp :value.sync="basist1dm.close_date" :disabled-days-of-Week="disabled" :format="format.toString()" :clear-button="clear" width="370px"></datepicker>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-xs-2">
                            <radio :checked.sync="basist1dm.closed" value="歿" type="warning">歿</radio>
                          </div>
                          <div class="col-xs-10">
                            <div class="row">
                              <label class="control-label col-xs-3" for="closedyear">西元年</label>
                              <div class="col-xs-3">
                                <multiselect :options="yearoptions" :selected.sync="basist1dm.closed_year" :multiple="false" :searchable="true" :close-on-select="false"
                              ...
                              <div class="col-xs-3">
                                <multiselect :options="monthoptions" :selected.sync="basist1dm.closed_month" :multiple="false" :searchable="true" :close-on-select="false"
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-3">
                                <multiselect :options="['Select option','意外','癌症','疾病','不明原因']" :selected.sync="basist1dm.closedcause" :multiple="false" :searchable="true" :close-on-select="false"
                                             :show-labels="false" @update="updateCause" label="closedcause">  </multiselect>
                              </div>
                              <div class="col-xs-6">
                                <bs-input name="closedreason" :value.sync="basist1dm.closedreason" placeholder="請填寫!"></bs-input>
                              </div>
                            </div>
                          </div>
                        </div>
                        <radio :checked.sync="basist1dm.closed" value="其它診斷" type="success">其它診斷</radio>
                      </div>
                      <div class="col-xs-1 col-xs-offset-1"><span> </span></div>
                    </div>
                    <br /><br />
                  ...
                  <div class="col-xs-12">
                    <button type="button" class="btn btn-warning" :disabled="!valid.all" @click="updateBasist1dm(basist1dm)"><i class="fa fa-pencil-square-o"></i>修改</button>
                    <button type="button" class="btn btn-danger" :disabled="!disablequery" @click="deleteBasist1dm(basist1dm)"><i class="fa fa-minus-circle"></i>刪除</button>
                  </div>
                </tab>
              </tabs>
            <!-- /div -->
...
//              })
  ...
  //          console.log(response.data)
      ...
      fetchToday () {
        ...
        this.today = thisday
        this.$set('basist1dm.log_date', thisday)
        this.$set('basist1dm.close_date', thisday)
//        this.$set('basist1dm.medicationdate', today)
//        this.$set('basist1dm.injectiondate', today)
//        console.log(this.today)
//        console.log(this.basist1dm.close_date)
      },
      fetchYear () {
        var date = new Date()
      ...
      deleteBasist1dm (basist1dm) {
        let self = this
        swal({
          title: '您確定嗎?!',
          text: '您將無法救回該名使用者的基本資料(T1DM)!!',
          type: 'warning',
          showCancelButton: true,
          confirmButtonText: '是的, 刪除它!!',
          cancelButtonText: '不, 保持原狀',
        }).then(function() {
  //        self.basist1dm.$remove(basist1dm)
          self.$http.delete('/api/basist1dm/' + basist1dm.id, basist1dm).then(function (response) {
            self.$router.go('/basist1dm')
            swal(
              '已刪除!!',
              '該名使用者的基本資料(T1DM)已經刪除!!',
              'success'
            )
            this.active = 0
            this.disablequery = 0
          }, function (response){
            show_stack_error('刪除使用者的基本資料(T1DM)發生錯誤!!', response)
          })
        }, function(dismiss) {
      ...
      createBasist1dm () {
        ...
        if (confirm("確定新增嗎?!")) {
          ...
          this.$http.post('/api/basist1dm', input)
            .then(function (response) {
              show_stack_info('已新增', response)
              // var pid = $('input[name="pid"]').val()
              // alert(pid)
              this.$set('basist1dm', response.data)
              //結案日期
              if(this.basist1dm.closed != "有") {
                this.$set('basist1dm.close_date', this.today)
              }
              // console.log(response.data.message)
              // console.log(this.basist1dm.fixedtime_from)
  //            this.$http({url: '/api/basist1dm/showpid/' + pid, method: 'GET'})
  //              .then(function (response) {
  //                this.$set('basist1dm', response.data)
  //              })
  //              .catch(function(response) {
  ...
  //              })
              ...
              if (response.data.error.message == "The pid has already been taken.") {
                show_stack_info('該基本資料(T1DM)已新增, 可修改!!', response)

                var pid = $('input[name="pid"]').val()
                this.$http({url: '/api/basist1dm/showpid1/' + pid, method: 'GET'})
                  .then(function (response) {
                    this.$set('basist1dm', response.data)
                    //結案日期
                    if(this.basist1dm.closed != "有") {
                ...
                show_stack_error('新增資料(T1DM)失敗!!', response)
              }
            })
            .catch(function(response) {
              console.log(response)
      ...
      updateBasist1dm (basist1dm) {
  //      event.preventDefault()
//        alert(basist1dm.closed)
        this.$http.patch('/api/basist1dm/' + basist1dm.id, basist1dm)
          .then(function (response) {
            show_stack_success('使用者的基本資料(T1DM)已更新!', response)
  //          alert(JSON.stringify(response))
            console.log('11' . response.data)
          }, function (response) {
            show_stack_error('使用者的基本資料(T1DM)更新失敗!', response)
  //          alert(response.data.error.message)
      ...
      updateYear (value) {
        this.basist1dm.fall_ill_year = value
      },
      updateMonth (value) {
        this.basist1dm.fall_ill_month = value
      },
      updatemYear (value) {
        this.basist1dm.medication_year = value
      },
      updatemMonth (value) {
        this.basist1dm.medication_month = value
      },
      updatecYear (value) {
        this.basist1dm.closed_year = value
      },
      updatecMonth (value) {
        this.basist1dm.closed_month = value
      },
      updategYear (value) {
        this.basist1dm.g6pd_year = value
      },
      updategMonth (value) {
        this.basist1dm.g6pd_month = value
      },
      updateiYear (value) {
        this.basist1dm.glp1_year = value
      },
      updateiMonth (value) {
        this.basist1dm.glp1_month = value
      },
      updatenYear (value) {
        this.basist1dm.injection_year = value
      },
      updatenMonth (value) {
        this.basist1dm.injection_month = value
      },
      updateMedication (value) {
        this.basist1dm.medication = value
      },
      updateLung (value) {
        this.basist1dm.lung = value
      },
      updateLiver (value) {
        this.basist1dm.liver = value
      },
      updateMental (value) {
        this.basist1dm.mental = value
      },
      updateGestation (value) {
        this.basist1dm.gestation = value
      },
      updateStopgestation (value) {
        this.basist1dm.stopgestation = value
      },
      updateHeartdisease (value) {
        this.basist1dm.heartdisease = value
      },
      updateBlindness (value) {
        this.basist1dm.blindness = value
      },
      updateDialysis (value) {
        this.basist1dm.dialysis = value
      },
      updateAmputation (value) {
        this.basist1dm.amputation = value
      },
      updateRelatives (value) {
        this.basist1dm.relatives = value
      },
      updateHypertension (value) {
        this.basist1dm.hypertension = value
      },
      updateCardiovascular (value) {
        this.basist1dm.cardiovascular = value
      },
      updateStroke (value) {
        this.basist1dm.stroke = value
      },
      updateActivity (value) {
        this.basist1dm.activity = value
      },
      updateEducation (value) {
        this.basist1dm.education = value
      },
      updateAffectlearning (value) {
        this.basist1dm.affectlearning = value
      },
      updateNursinghome (value) {
        this.basist1dm.nursinghome = value
      },
      updateCause (value) {
        this.basist1dm.closedcause = value
      }
    },
    computed: {
      isSum: function () {
        var ss = 0
        if (this.basist1dm.sporta1 != null && this.basist1dm.sporta2 != null) {
          ss = this.basist1dm.sporta1 * this.basist1dm.sporta2
        }
        if (this.basist1dm.sportb1 != null && this.basist1dm.sportb2 != null) {
          ss = ss + this.basist1dm.sportb1 * this.basist1dm.sportb2
        }
        if (this.basist1dm.sportc1 != null && this.basist1dm.sportc2 != null) {
          ss = ss + this.basist1dm.sportc1 * this.basist1dm.sportc2
        }
        $('input[name="sportsum"]').val(ss)
        return (ss >= 0)
      },
      isNone: function () {
        if (this.basist1dm.symptom != null) {
          var symptoms = this.basist1dm.symptom || ""
  ...
  //    },
      isNoneT: function () {
        if (this.basist1dm.treatment != null) {
          var treatments = this.basist1dm.treatment || ""
          var a = treatments.indexOf("無")
          if (a >= 0) {
            this.basist1dm.insulin = ""
            this.basist1dm.longterm = ""
            this.basist1dm.ineffect = ""
            this.basist1dm.shortacting = ""
            this.basist1dm.quickeffect = ""
      ...
      isNoneC: function () {
        if (this.basist1dm.comorbidity != null) {
          var comorbiditys = this.basist1dm.comorbidity || ""
          var a = comorbiditys.indexOf("無共病")
          if (a >= 0) {
            this.basist1dm.cancer = ""
      ...
      isNoneN: function () {
        if (this.basist1dm.complication != null) {
          var complications = this.basist1dm.complication || ""
      ...
      isNoneF: function () {
        if (this.basist1dm.fami_medic_his != null) {
          var fami_medic_hiss = this.basist1dm.fami_medic_his || ""
